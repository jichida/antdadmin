          ...
          <TabbedForm toolbar={<EditToolbar />}>
              <FormTab label="系统设置">
                <NumberInput
                  ...
                  style={{ width: "100%" }}
                />
              <ReferenceInput label='硬件商城类别' source="productcategoryid_hardware" reference="category" allowEmpty
                filter={{querystring:'!parent_id'}}>
                  <SelectInput optionText="name" />
              </ReferenceInput>
              <ReferenceInput label='积分商城类别' source="productcategoryid_point" reference="category"  allowEmpty
